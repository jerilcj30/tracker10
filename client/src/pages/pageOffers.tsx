...
import { columns } from "../components/TableOffers/columns";
import { DataTable } from "../components/TableOffers/data-table";
import { useQuery } from "@tanstack/react-query";
import { DateRangePicker } from "../components/ui/date-range-picker";
import { getOffers } from "../api/apiOffers";
import { DialogButton } from "../components/FormCreateOffer/dialog";
...
export default function Offers() {
  ...
  const { data} = useQuery({
    ...
    queryKey: ["displayOffers", startDate, endDate],
    queryFn: async () => {
      try {
        return await getOffers(startDate, endDate);
      } catch (error) {
