/*
This component is not from shadcn. This is from the below git repo file
...
import { Framework } from "@/pages/pageCampaign";
...
export function FancyMultiSelect({ frameworks }: FancyMultiSelectProps) {
